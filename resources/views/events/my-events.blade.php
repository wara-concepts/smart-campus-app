                            ...
                            <tbody>
                                @foreach($organizedEvents as $event)
                                    <tr>
                                        ...
                                        <td>{{ $event->participant_count }} / {{ $event->max_participants > 0 ? $event->max_participants : '∞' }}</td>
                                        <td>
                                        ...
                                        <td>
                                            <div class="flex space-x-2">
                                                ...
                                                <a href="{{ route('events.attendance', $event->id) }}" class="btn btn-sm btn-primary">Attendance</a>
                                            </div>
                                        </td>
                                    </tr>
                                @endforeach
