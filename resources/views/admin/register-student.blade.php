<x-app-layout>
    ...
    <div class="py-6">
        <div class="container-fluid px-6 col-6">
...
<form method="POST" action="{{ route('register.student') }}">
    @csrf
        ...
        <div class="mt-4">
            ...
            <x-text-input id="fullname" class="block mt-1 w-full" type="text" name="fullname" :value="old(';fullname')" required autofocus autocomplete="fulllname" />
        ...
        <div class="mt-4">
            ...
            <x-text-input id="phone" class="block mt-1 w-full" type="tel" name="phone" :value="old('phone')" required pattern="[0-9]+"/>
